...
export default function PricingSection({ isUpsellOpen: controlledUpsellOpen, setIsUpsellOpen: controlledSetUpsellOpen }) {
  ...
  return (
    <section id="oferta" className="py-16 md:py-24 bg-black border-b border-white/10 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 max-w-6xl relative z-10">
        ...
        <div className="w-full max-w-5xl mx-auto flex flex-col items-center justify-center gap-8 lg:flex-row lg:items-stretch">
          ...
          <div className="w-full max-w-md mx-auto bg-[#0F0F14]/90 backdrop-blur-md border-2 border-[#e52521] rounded-none overflow-hidden relative shadow-2xl flex flex-col justify-between transform lg:-translate-y-4">
            ...
            <div className="p-6 md:p-8 pt-0 flex flex-col items-center">
              <a
                href="https://checkout.payt.com.br/0b6389f999e633cc8c5314d85612226a?payment=pix"
                onClick={(e) => handleCheckoutClick(e, 'ACESSO 3D PRO', 37.90, 'https://checkout.payt.com.br/0b6389f999e633cc8c5314d85612226a?payment=pix')}
                target="_blank"
      ...
      {/* POP UP UPSELL - OFERTA DO PLANO PRO POR R$ 27,90 AO CLICAR NO BÁSICO */}
      <AnimatePresence>
        {isUpsellOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
            ...
            >
              ...
              <h3 className="text-white font-display font-black text-xl sm:text-2xl uppercase tracking-tight leading-tight mb-2">
                Leve o <span className="text-[#e52521]">ACESSO 3D PRO</span> por Apenas <span className="text-yellow-400">R$ 27,90</span>
              </h3>

              <p className="text-white/80 text-xs sm:text-sm mb-4 leading-relaxed max-w-md mx-auto">
                Por apenas <strong>mais R$ 18,00</strong>, desbloqueie a coleção completa com todos os +500 modelos, novas coleções todo mês e todos os 5 super bônus!
              </p>
              ...
              <div className="flex items-baseline justify-center gap-2 mb-4">
                <span className="text-white/50 line-through text-sm font-bold">De R$ 37,90</span>
              ...
              <button
                type="button"
                onClick={(e) => {
                  handleCheckoutClick(e, 'UPGRADE ACESSO 3D PRO (MODAL)', 27.90, 'https://checkout.payt.com.br/1706db933f1482449a8faef7f01edc76?payment=pix');
                  setIsUpsellOpen(false);
                }}
              ...
              >
                <span>SIM! QUERO APROVEITAR POR R$ 27,90</span>
              </button>
              ...
              <button
                type="button"
                onClick={(e) => {
                  handleCheckoutClick(e, 'PACOTE BÁSICO', 9.90, 'https://checkout.payt.com.br/589c687712d833fa3f5c7475b3413943?payment=pix');
                  setIsUpsellOpen(false);
                }}
